...
class SingleBlog2Screen extends StatefulWidget {
  static const String id = 'SingleBlog2Screen';

  @override
  _SingleBlog2ScreenState createState() => _SingleBlog2ScreenState();
}

class _SingleBlog2ScreenState extends State<SingleBlog2Screen> {
  String title;
  int userId;
  String body;
  @override
